...
public interface FinalInspectionCallService {
     ...
     */
    List<String> getRmIcCertificateNumbers(String vendorId);
     ...
     * @param rmCertificateNo - RM IC certificate number (e.g., "N/ER-01120005/RAJK")
     ...
     * @param rmCertificateNo - RM IC certificate number (e.g., "N/ER-01120005/RAJK")
     * @param processCertificateNo - Process IC certificate number (e.g., "N/EP-01170002/RAJK")
     * @return List of lot numbers
     */
     ...
     * @return List of lot numbers
     */
    List<String> getLotNumbersByMultipleRmAndProcessCertificates(List<String> rmCertificateNos, List<String> processCertificateNos);
}
