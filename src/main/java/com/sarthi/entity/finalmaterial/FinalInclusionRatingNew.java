...
/**
 * Parent Entity for Final Inspection - Inclusion Rating (New Structure)
 *
...
@Data
public class FinalInclusionRatingNew {
    ...
    /**
     * Sampling type (e.g., Random, Systematic, etc.).
     */
    @Column(name = "sampling_type", length = 50)
     ...
     */
    @OneToMany(mappedBy = "finalInclusionRating", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
    private List<FinalInclusionRatingSample> samples;
