...
/**
 * Parent Entity for Final Inspection - Application & Deflection Test
 *
 ...
 *
 * Design Semantics:
 * - One row in final_application_deflection = one inspection session.
 * - Many rows in final_application_deflection_samples = all sample readings.
 ...
 */
@Entity
@Table(name = "final_application_deflection", indexes = {
    @Index(name = "idx_final_app_defl_call_no", columnList = "inspection_call_no"),
    @Index(name = "idx_final_app_defl_lot_no", columnList = "lot_no"),
    @Index(name = "idx_final_app_defl_heat_no", columnList = "heat_no"),
    @Index(name = "idx_final_app_defl_status", columnList = "status")
},
uniqueConstraints = {
    @UniqueConstraint(name = "uk_final_app_defl_unique", columnNames = {"inspection_call_no", "lot_no", "heat_no"})
})
@Data
public class FinalApplicationDeflection {
